...
namespace Enfinity.Hrms.Test.UI
{
    public class PayrollEmployeePage
    {
        ...
        // Constructor
        public PayrollEmployeePage(IWebDriver driver)
        {
            _driver = driver;
        }
        ...
        {
            CommonActions.setDropdownValueEmp("Systems Analyst");
        }
        ...
        {
            CommonActions.setDropdownValueEmp("for flipkart");
        }
        ...
        {
            CommonActions.setDropdownValueEmp("Contributor");
        }
        ...
        {
            CommonActions.setDropdownValueEmp("Male");
        }
        ...
        {
            CommonActions.setDropdownValueEmp("Hindu");
        }
        ...
        {
            CommonActions.setDropdownValueEmp("Married");
        }
        ...
        {
            if (CommonActions.resultEmp().Contains(expname))
            {
                return true;
            }
            else
