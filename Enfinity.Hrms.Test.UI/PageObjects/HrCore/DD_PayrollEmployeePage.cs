...
{
    public class DD_PayrollEmployeePage
    {
        ...
        // Constructor
        public DD_PayrollEmployeePage(IWebDriver driver)
        {
            _driver = driver;
        }
        ...
        {
            //CommonActions.setDropdownValueEmp("Vaibhav Chavan");
            _driver.FindElement(slctmgr).Click();
        }

        public void SetMobileNumber(string mbl)
        {
        ...
        {
            CommonActions.setDropdownValueEmp(dept);
        }
        ...
        public void SelectDesig(string desg)
        {
            CommonActions.setDropdownValueEmp(desg);
        }
        ...
        {
            CommonActions.setDropdownValueEmp(payrollset);
        }
        ...
        {
            CommonActions.setDropdownValueEmp(calendar);
        }
        ...
        {
            CommonActions.setDropdownValueEmp(indemnity);
        }
        ...
        {
            CommonActions.setDropdownValueEmp(grade);
        }
        ...
        {
            CommonActions.setDropdownValueEmp(gender);
        }
        ...
        {
            CommonActions.setDropdownValueEmp(religion);
        }
        ...
        {
            CommonActions.setDropdownValueEmp(maritalStatus);
        }
        ...
        {
            CommonActions.setDropdownValueEmp(role);
        }
        ...
        {
            if (CommonActions.resultEmp().Contains(empname))
            {
                return true;
            }
            else
