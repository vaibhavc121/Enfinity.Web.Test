...
namespace Enfinity.Hrms.Test.UI
{
    public class HRCoreDataProvider
    {
        ...
        {
            yield return new TestCaseData("abc121@gmail.com", "Mohan", "7769765434", "01-Jan-2024", "prod", "Systems Analyst", "Test", "for flipkart", "Indemnity2", "Contributor", "Male", "Muslim", "Married", "mohan@test.com", "AA");
            //yield return new TestCaseData("abc121@gmail.com", "Manoj", "7769765434", "01-Jan-2024", "prod", "Systems Analyst", "for flipkart", "Contributor", "Male", "Hindu", "Married");
        }
    }
}
